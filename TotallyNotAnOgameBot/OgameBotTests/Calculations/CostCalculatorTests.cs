...
namespace OgameBotTests.Calculations
{
    ...
    public class CostCalculatorTests
    {
        ...
        [TestCase(Building.Type.MetalStorage, 5, 16000, 0, 0, 0)]
        [TestCase(Building.Type.MissileSilo, 5, 320000, 320000, 16000, 0)]
        ...
        [TestCase(Spaceships.Type.Recycler, 5, 50000, 30000, 10000, 0)]
